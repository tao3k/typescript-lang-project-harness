...
Usage:
  ...
  ts-harness agent install --client codex [project-root]
  ts-harness agent guide --client codex [project-root]
  ts-harness agent hook --client codex <event> [project-root]
